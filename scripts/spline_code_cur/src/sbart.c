...
int c_sslvrg( double *x, int n, double *knot, int nk, double *coef,
              double *sz, double lambda, double *xwy, double *hs0, double *hs1, double *hs2, double *hs3,  
              double *sg0, double *sg1, double *sg2, double *sg3,  double *abd, int ld4);

/***************************************************************************//**
 * @brief Cubic B-spline Smoothing routine, see source for more info
 ******************************************************************************/
int sbart
